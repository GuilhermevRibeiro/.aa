...
#aqui mostra o path que o arquivo vai, mudar para o do seu pc.
dados_excel = pd.read_excel("C:\\Users\\Guilherme\\Downloads\\Contratos.xls")
#dados_contratos = pd.read_excel("C:\\Users\\Guilherme\\Downloads\\Contratos.xls", sheet_name="Contratos")
#dados_itens_contratos = pd.read_excel("C:\\Users\\Guilherme\\Downloads\\Contratos.xls", sheet_name="Itens Contratos")

#dados do banco de dados, mudar para o do que voce criou
...
# criar o "cursor" que vai "fazer" os comandos.
cursor = meubd.cursor()

#trata os dados que estão no excel, o bando de IF ELSE é pra tratar os valores que não tem nada ou 0.0
...
"""
comandos no mysql para ver se deu certo: 
...
show tables;
desc contratos; -- esse é só pra ver se a table foi criada certo
